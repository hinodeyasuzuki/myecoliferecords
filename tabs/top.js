export default {
  template: `
    <section id="top-tab">
      ...
      <div>
      <p>　「機器」タブで、登録できます。</p>
      <p>　「▼機器分類を表示」を押して、分類を選んでください。</p>
      <p>　「＋追加する」を押すと、中古品や手作りの内容を登録できます。</p>
      </div>
      </article>
      ...
      <h3>修理した</h3>
      <div>
      <p>　まずは「機器」タブで、修理した製品を登録してください。すでに登録されている場合には該当製品を選びます。</p>
      ...
      <h3>省エネ診断をしたい</h3>
      <div>
      <p>　「診断項目」タブで、生活状況を回答し、効果的な省エネ対策を計算できます。</p>
      <p>　すべての項目を入力しなくても、診断結果は得られます。</p>
      </div>
      </article>
      </section>
